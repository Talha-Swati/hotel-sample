...
export const staysData = [
  ...
  },
  {
    ...
    description:
      "Apple 2: Kona Meadows is ideal for relaxed family stays with a creek nearby, shaded seating, and an open-plan living area. Unplug and enjoy nature with plenty of space to gather.",
    category: "family",
    rating: 4.8,
    reviews: 96,
    sleeps: 4,
  ...
  },
  {
    ...
    description:
      "Triangle 1: Catalina Ridge blends modern architecture with Texas skies. Relax inside an airy, light-filled space or unwind outside under the stars.",
    category: "value",
    rating: 4.7,
    reviews: 74,
    sleeps: 3,
  ...
  },
  {
    ...
    description:
      "Triangle 2: Rani Ridge offers a peaceful hideaway with soft interiors and a large outdoor deck. Ideal for small groups who want a calm, comfortable base.",
    category: "group",
    rating: 4.8,
    reviews: 88,
    sleeps: 5,
