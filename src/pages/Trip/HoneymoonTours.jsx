...
const HoneymoonTours = () => {
  ...
  const featuredStays = staysData.filter((stay) =>
    ['cedar-ridge', 'mesa-loft'].includes(stay.slug)
  );
  ...
  return (
    <PageLayout
      seo={{
        title: 'Romantic Stays in Texas Hill Country | Tiny Escape',
        description: 'Romantic tiny homes and cabins with private decks, scenic views, and celebration-ready add-ons.',
        keywords: 'Texas romantic stays, Hill Country honeymoon cabins, couples getaway, anniversary stay',
        url: '/trip/honeymoon'
      }}
